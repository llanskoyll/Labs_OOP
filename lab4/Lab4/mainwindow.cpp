    ...
    , ui(new Ui::MainWindow)
{
    ...
    //открыть файл
    CSVReader csv("D:\\Qt\\labs\\lab4\\Lab4\\employee.txt"); //ставлю абсолютный путь. Нужно поменять, когда будете запускать на своем копьютере.
    if (csv.is_open()) {
...
void MainWindow::saveFile() {
    CSVWriter fout("D:\\Qt\\labs\\lab4\\Lab4\\new_employee.txt");
